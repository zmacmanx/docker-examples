...
then
	...
	then
		...
		clear
		echo "--------------------------"
		echo "Docker volumes are based on underlying technology.  Exploring this primitive we will discover the different types "
		echo "volume types and the use for each of them in the docker architecture. "
		echo ""
